...
class Gio_hang
{
    public function Them($id,$ten,$dg,$sl,$hinh)
    {        
        if(isset($_SESSION['giohang']))
        {
            $giohang=$_SESSION['giohang'];
            if(isset($giohang[$id]))
                $giohang[$id]=array($dg,$giohang[$id][1]+$sl,$ten,$hinh);
            else
                $giohang[$id]=array($dg,$sl,$ten,$hinh);
            $_SESSION['giohang']=$giohang;    
        }
        else
            $_SESSION['giohang']=array($id=>array($dg,$sl,$ten,$hinh));               
    }
