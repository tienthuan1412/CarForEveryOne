                ...
                <div class="box-body">
                    <form role="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-warning">
                            <label class="control-label" for="ten_hang_url"><i class="fa fa-bell-o"></i> Tên hãng Xe URL</label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="btn btn-primary" type="submit" value="Thêm" name="btnThemLoai" />
