...
<html>
  ...
  <body class="login-page">
      ...
      <div class="login-box-body">
        ...
        <form action="#" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="User Name" autofocus name="username" value="{$username}" />
    ...
    <!-- jQuery 2.1.4 -->
    <script src="{$path}public/admin/plugins/jQuery/jQuery-2.1.4.min.js" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="{$path}public/admin/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <!-- iCheck -->
    <script src="{$path}public/admin/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
